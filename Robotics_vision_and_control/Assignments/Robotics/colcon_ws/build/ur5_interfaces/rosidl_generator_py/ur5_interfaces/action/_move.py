...
class Metaclass_Move_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ur5_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Move_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ur5_interfaces.action import Move
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'ur5_interfaces/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur5_interfaces', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ur5_interfaces.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur5_interfaces.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ur5_interfaces.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from ur5_interfaces.action._move import Move_SendGoal_Request as Request
    from ur5_interfaces.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'ur5_interfaces/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur5_interfaces', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ur5_interfaces.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur5_interfaces.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from ur5_interfaces.action._move import Move_GetResult_Request as Request
    from ur5_interfaces.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ur5_interfaces.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'ur5_interfaces/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ur5_interfaces', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from ur5_interfaces.action._move import Move_Feedback
...
class Move(metaclass=Metaclass_Move):
    ...
    from ur5_interfaces.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from ur5_interfaces.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from ur5_interfaces.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from ur5_interfaces.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from ur5_interfaces.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from ur5_interfaces.action._move import Move_FeedbackMessage as FeedbackMessage
