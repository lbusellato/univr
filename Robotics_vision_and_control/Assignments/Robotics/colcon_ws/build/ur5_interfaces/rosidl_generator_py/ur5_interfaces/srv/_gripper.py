...
class Metaclass_Gripper(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ur5_interfaces.srv import _gripper
...
class Gripper(metaclass=Metaclass_Gripper):
    from ur5_interfaces.srv._gripper import Gripper_Request as Request
    from ur5_interfaces.srv._gripper import Gripper_Response as Response
