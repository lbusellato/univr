...
bool ur5_interfaces__srv__add_three_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur5_interfaces.srv._add_three_ints.AddThreeInts_Request", full_classname_dest, 55) == 0);
  }
  ur5_interfaces__srv__AddThreeInts_Request * ros_message = _ros_message;
  {  // a
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * ur5_interfaces__srv__add_three_ints__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of AddThreeInts_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ur5_interfaces.srv._add_three_ints");
  ...
  ur5_interfaces__srv__AddThreeInts_Request * ros_message = (ur5_interfaces__srv__AddThreeInts_Request *)raw_ros_message;
  {  // a
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool ur5_interfaces__srv__add_three_ints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur5_interfaces.srv._add_three_ints.AddThreeInts_Response", full_classname_dest, 56) == 0);
  }
  ur5_interfaces__srv__AddThreeInts_Response * ros_message = _ros_message;
  {  // sum
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * ur5_interfaces__srv__add_three_ints__response__convert_to_py(void * raw_ros_message)
{
  ...
  ur5_interfaces__srv__AddThreeInts_Response * ros_message = (ur5_interfaces__srv__AddThreeInts_Response *)raw_ros_message;
  {  // sum
    PyObject * field = NULL;
