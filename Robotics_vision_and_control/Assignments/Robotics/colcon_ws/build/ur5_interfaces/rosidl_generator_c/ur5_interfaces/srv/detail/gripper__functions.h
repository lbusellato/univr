...
#ifndef UR5_INTERFACES__SRV__DETAIL__GRIPPER__FUNCTIONS_H_
#define UR5_INTERFACES__SRV__DETAIL__GRIPPER__FUNCTIONS_H_
 ...
 * calls
 * ur5_interfaces__srv__Gripper_Request__init().
...
/**
 * It calls
 * ur5_interfaces__srv__Gripper_Request__fini()
 ...
 * ur5_interfaces__srv__Gripper_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ur5_interfaces__srv__Gripper_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur5_interfaces__srv__Gripper_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5_interfaces
...
/**
 * It calls
 * ur5_interfaces__srv__Gripper_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ur5_interfaces__srv__Gripper_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur5_interfaces
...
/**
 * It calls
 * ur5_interfaces__srv__Gripper_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UR5_INTERFACES__SRV__DETAIL__GRIPPER__FUNCTIONS_H_
